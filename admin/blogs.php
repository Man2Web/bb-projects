...
$sql="select blogs.*,categories.categories from blogs,categories where blogs.categories_id=categories.id order by blogs.id desc";
	...
	<div class="orders">
	   <div class="row">
		  <div class="col-xl-12">
			 <div class="card">
				<div class="card-body">
				   <h4 class="box-title" style="float:left">Posts </h4>
				   <h4 class="btn btn-success" style="float:right;"><a href="manage_blogs.php" style="color:white"><i class="fa fa-plus-circle"></i> Add Posts</a> </h4>
				</div>
				<div class="card-body--">
